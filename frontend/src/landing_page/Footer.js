...
function Footer() {
    return ( 
       ...
       <div className='container border-top mt-10'>
        <div className='row mt-5'>
            ...
            <p>Support</p>
                ...
                <a href="" style={{textDecoration:"none"}}>Z-connect blogs </a><br/>
                ...
                <a href="" style={{textDecoration:"none"}}>Market Review</a><br/>
                <a href="" style={{textDecoration:"none"}}>How to file a complaints?</a><br/>
        ...
        <div className="mt-5 fs-15 text-muted">
